...
from denoisr_chess.nn.diffusion import DPMSolverPP
...
from denoisr_chess.training.phase_orchestrator import PhaseConfig, PhaseOrchestrator
from denoisr_chess.training.phase2_trainer import Phase2Trainer, TrajectoryBatch
...
from denoisr_chess.training.self_play import (
    SelfPlayActor,
    SelfPlayConfig,
    TemperatureSchedule,
)
...
from denoisr_chess.types import GameRecord, TrainingExample
...
@graceful_main("denoisr-chess-train-phase3", logger=log)
def main() -> None:
    load_env_file()
