...
from denoisr_chess.inference.uci import run_uci_loop
...
@graceful_main("denoisr-chess-play")
def main() -> None:
    load_env_file()
    ...
    def load_model() -> None:
        ...
        if args.mode == "diffusion":
            from denoisr_chess.inference.diffusion_engine import DiffusionChessEngine
