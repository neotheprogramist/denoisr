...
from denoisr_chess.gui.board_widget import BoardWidget, SOLID_PIECE_SYMBOLS
from denoisr_chess.engine.types import EngineConfig, TimeControl
from denoisr_chess.engine.uci_engine import UCIEngine

if TYPE_CHECKING:
    from denoisr_chess.engine.types import GameResult
...
class DenoisrApp:
    ...
    def _new_game(self) -> None:
        ...
        args = ["run", "denoisr-chess-play", "--checkpoint", ckpt, "--mode", mode]
    ...
    def _start_match(self) -> None:
        ...
        from denoisr_chess.engine.match_engine import run_match
        from denoisr_chess.engine.types import MatchConfig
        ...
        mode = self._engine_mode_var.get()
        e1_args = ("run", "denoisr-chess-play", "--checkpoint", ckpt, "--mode", mode)
