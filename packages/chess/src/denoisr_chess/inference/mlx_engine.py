...
from safetensors files exported by denoisr-chess-export-mlx.
...
from denoisr_chess.inference._weight_remap import _remap_all_keys
...
class MLXChessEngine:
    ...
    Loads weights from safetensors exported by denoisr-chess-export-mlx and
