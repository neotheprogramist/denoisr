...
import denoisr_chess.apps.train_phase3 as train_phase3
from denoisr_chess.types import Action, GameRecord, PolicyTarget, TrainingExample, ValueTarget
